...
public class DownloadItemStream
{
    ...
    public static Operation<DownloadItemStream> Create(int id, string tempPath, string filePath, Video video, IStreamInfo stream)
    {
    ...
    public static Operation<DownloadItemStream> Create(int id, string tempPath, string filePath, Video video, IAudioStreamInfo audioStream, IVideoStreamInfo videoStream)
    {
